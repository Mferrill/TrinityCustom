...
// Previous Update: September 28th by Lorac of 2011
// Last Updated: October 27 by Pryd of 2011

#include "ScriptPCH.h"
#include "../../shared/Configuration/Config.h"
#ifndef _TRINITY_CORE_CONFIG
# define _TRINITY_CORE_CONFIG  "worldserver.conf"   // <-- If using trinity switch UC-World.conf to worldserver.conf
...
bool OnGossipHello(Player *player, Creature* pCreature)
{
  ...
  if(ConfigMgr::GetBoolDefault("pryds_telenpc.OnlyGMs", false)) // If pryds_telenpc.OnlyGMs is enabled in trinitycore.conf
    ...
    bool EnableFactionMalls = ConfigMgr::GetBoolDefault("pryds_telenpc.EnableFactionMalls", true);
    bool EnableShoppingMall = ConfigMgr::GetBoolDefault("pryds_telenpc.EnableShoppingMall", true);
...
bool EnableResSickness = ConfigMgr::GetBoolDefault("pryds_telenpc.EnableFactionMalls", false);
